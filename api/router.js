...
router.post('/mastery', (req, res, next) => {
  ...
  if(valid.user(summonerName)){
    axios.get(`https://na1.api.riotgames.com/lol/summoner/v3/summoners/by-name/${summonerName}?api_key=${process.env.API_KEY}`)
      .then(function (response) {
        ...
        axios.get(`https://na1.api.riotgames.com/lol/champion-mastery/v3/champion-masteries/by-summoner/${user.id}?api_key=${process.env.API_KEY}`)
          .then(function (response) {
